...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <?php
$conn=mysqli_connect("localhost","root","G@m3r0pinthechat","umadevi");
	$mysqli = "SELECT* FROM main where status='incomplete'";
    $resulti = mysqli_query($conn, $mysqli);
...
<tr><td></td><td>Enter the sno : </td><td><input type="text" name="sno"></td><td><input class="btn btn-success" type="submit" value="Click to continue"></td>
